...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_Base] = LAYOUT(
        ...
        TT(L_FnCp), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,      KC_ENT          ,   KC_P4,   KC_P5,   KC_P6,
    ...
    [L_FnCp] = LAYOUT(
        ...
        _______,    _______, _______, _______, _______, _______, _______, KC_P7,   KC_P8,   KC_P9,   KC_PPLS, _______,      CTL_MINS,CTL_PLUS,  KC_NUM,  NEW_BLD, ENCRYPT, _______,
        KC_F6  ,    _______, _______, _______, _______, _______, _______, KC_P4,   KC_P5,   KC_P6,   KC_PMNS, _______,      _______, CTL_RBRC,  _______, _______, _______, _______,
        TT(L_FnCp), _______, _______, _______, _______, _______, _______, KC_P1,   KC_P2,   KC_P3,   KC_PAST, _______,      _______,  _______,  _______, _______,
