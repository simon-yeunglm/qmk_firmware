...
//        return;
    ...
    // pulse launched from back space
    {
        ...
        const float pulseStartPos   = 60.0f;
    ...
    if (isContinueRenderPass)
    {
		const float3    scrollColor[]= { 
			...
			{0.45f , 0.025f  , 0.025f },     // red
			{0.45f , 0.2f  , 0.025f },    // orange
			{0.35f  , 0.35f  , 0.025f },  // yellow
			{0.175f, 0.23f , 0.45f },    // cyan 1
			{0.1f, 0.175f, 0.45f },      // cyan 2
			{0.025f  , 0.025f  , 0.35f },    // blue
			{0.18f, 0.1f  , 0.25f},     // purple
			{0.25f , 0.1f  , 0.25f},    // pink
		};
        const int       numColor    	    = sizeof(scrollColor)/sizeof(float3);
        const float     distanceBetweenColor= 16.0f;
        const float     changeColorTime     = 2.5f;
