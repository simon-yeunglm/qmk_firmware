...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT( /* FN */
        ...
        _______, _______, _______, KC_CALC, MACRO_TEST  , _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______,                   _______, RGB_VAI,  _______, _______, _______,   _______,
